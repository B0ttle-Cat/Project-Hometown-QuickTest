...
namespace StrategyManagerModule
{
	...
	public partial class StrategyPointingProcess
	{
		...
		{
			if (ThisProcess.TryGetProcessOverrider<ProcessOverrider_PointingAtGround>(out var hack))
			{
		...
		{
			if (ThisProcess.TryGetProcessOverrider<ProcessOverrider_PointingAtSector>(out var hack))
			{
				hack.InvokeOverrider(pointing);
				return;
			}
	...
	{
		private IStrategyProcess pointingProcess;
		public IStrategyProcess PointingProcess
		{
			get
			{
				...
				{
					pointingProcess = new StrategyPointingProcess();
					ProcessList.Add(pointingProcess);
				}
