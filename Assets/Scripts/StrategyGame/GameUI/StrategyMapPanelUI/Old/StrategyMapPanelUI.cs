...
public partial class Old_StrategyMapPanelUI : MonoBehaviour, IGamePanelUI, IStrategyStartGame
{
...
public partial class Old_StrategyMapPanelUI : IViewAndControlModeChange
{
...
public partial class Old_StrategyMapPanelUI // MapPanelUI
{
	...
	{
		protected Old_StrategyMapPanelUI ThisPanel { get; private set; }
		protected GameObject Preafab { get; private set; }
		protected Transform Parent { get; private set; }
		private bool isShow = false;
		public bool IsShow => isShow;

		protected MapPanelUI(GameObject preafab, Transform parent, Old_StrategyMapPanelUI panel)
		{
			ThisPanel = panel;
	...
	public abstract class MapLabelGroup<T> : MapPanelUI where T : MapLabelGroup<T>.MapLabel
	{
		...
		protected MapLabelGroup(GameObject preafab, Transform parent, Old_StrategyMapPanelUI panel) : base(preafab, parent, panel)
		{
