	...
	public class SectorLabelGroup : MapLabelGroup<SectorLabelGroup.SectorLabel>
	{
		...
		public class SectorLabel : MapLabel
		{
			...
			protected override void Invisible()
			{
				...
				//if (CardTarget != null)
				//{
				//	CardTarget.SectorStatsGroup.RemoveListener(OnChangeStatsGroup, OnChangeStatsGroup);
				//}
			}
			...
			protected override void Visible()
			{
				...
				//if (CardTarget != null)
				//{
				//	CardTarget.SectorStatsGroup.AddListener(OnChangeStatsGroup, OnChangeStatsGroup);
				//}
			}
			...
			public void ChangeIconList()
			{
				if (iconParent != null)
				{
					...
					//var keyList = CardTarget.GetStatsKeyListInGroup(SectorObject.StatsGroupName_StatusEffect);
