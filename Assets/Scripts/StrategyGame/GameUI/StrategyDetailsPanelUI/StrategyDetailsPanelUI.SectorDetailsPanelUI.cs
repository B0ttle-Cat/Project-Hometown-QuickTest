...
public partial class StrategyDetailsPanelUI // SectorDetailsPanelUI
{
	...
	public class SectorDetailsPanelUI : IDisposable
	{
		...
		[ShowInInspector, HideInEditorMode]
		private SectorDetails_Garrison sectorDetails_Garrison { get; set; }
		public void OnShowSectorDetail(SectorObject sectorObject, DetailsType detailsType = DetailsType.None)
		{
			...
			sectorDetails_Garrison?.Dispose();
			...
			sectorDetails_Garrison = new SectorDetails_Garrison(sectorObject, ThisPanelUI, uiPrefabStruct.garrison);
			...
			ThisPanelUI.tabControl.AddTab(("", null),
				...
				("주둔 병력", ShowTabAndContnet_Garrison)
				);
			...
			Action onShow = detailsType switch
			{
				...
				DetailsType.Garrison => ShowTabAndContnet_Garrison,
			...
			void ShowTabAndContnet_Garrison()
			{
				lastDetailsType = DetailsType.Garrison;

				sectorDetails_MainInfo.Hide();
				sectorDetails_Support.Hide();
				sectorDetails_Facilities.Hide();

				sectorDetails_Garrison.Show();
			}
		}
		public void OnHideSectorDetail()
		{
		...
		[Serializable]
		public class SectorDetails_Garrison : SectorContentPanel
		{
			public SectorDetails_Garrison(SectorObject sectorObject, StrategyDetailsPanelUI thisPanel, RectTransform contentPrefab)
				: base(sectorObject, thisPanel, contentPrefab)
			{
