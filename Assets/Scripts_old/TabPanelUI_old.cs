...
public class TabPanelUI_old : MonoBehaviour
{
	[SerializeField]
	...
	{
		protected TabPanelUI_old component;

		public ContentController(TabPanelUI_old component)
		{
	...
	public abstract class ViewController : IDisposable
	{
		...
		public void Init(TabPanelUI_old component, ContentController viewModel) 
		{
			this.component = component;
