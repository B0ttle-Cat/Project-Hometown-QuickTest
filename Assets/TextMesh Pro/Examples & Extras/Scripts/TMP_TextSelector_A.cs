...
namespace TMPro.Examples
{
    ...
    public class TMP_TextSelector_A : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        void Awake()
        {
            ...
            // Force generation of the Text object so we have valid _capture to work with. CurrentRect is needed since LateUpdate() will be called before the Text object has a chance to generated when entering play mode.
        ...
        void LateUpdate()
        {
            ...
            if (m_isHoveringObject)
            {
                ...
                {
                    //m_TextPopup_RectTransform.Target.SetActive(false);
                    m_selectedLink = -1;
                }
                ...
                if (linkIndex != -1 && linkIndex != m_selectedLink)
                {
                    ...
                    switch (linkInfo.GetLinkID())
                    {
                        case "id_01": // 100041637: // id_01
                                      ...
                                      //m_TextPopup_RectTransform.Target.SetActive(true);
