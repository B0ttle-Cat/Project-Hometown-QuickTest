...
namespace TMPro
{
    ...
    public class TMP_TextEventHandler : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        void Awake()
        {
            ...
            // Get a reference to the camera rendering the Text taking into consideration the Text ThisComponent type.
        ...
        void LateUpdate()
        {
            ...
            {
                // ResetUpdateFlag all selections given we are hovering outside the Text container bounds.
                m_selectedLink = -1;
                m_lastCharIndex = -1;
                m_lastWordIndex = -1;
                m_lastLineIndex = -1;
