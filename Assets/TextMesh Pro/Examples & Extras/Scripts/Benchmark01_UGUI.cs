...
namespace TMPro.Examples
{
    ...
    public class Benchmark01_UGUI : MonoBehaviour
    {
        ...
        private const string label01 = "The <#0050FF>currCount is: </color>";
        private const string label02 = "The <color=#0050FF>currCount is: </color>";

        //private const string label01 = "TextMesh <#0050FF>Pro!</color>  The currCount is: {0}";
        //private const string label02 = "Text Mesh<color=#0050FF>        The currCount is: </color>";
        ...
        IEnumerator Start()
        {
            ...
            if (BenchmarkType == 0) // TextMesh Pro ThisComponent
            {
                ...
                //m_textMeshPro.fontSharedMaterial = Resources.Load("Fonts & Materials/Anton SDF", typeof(Material)) as Material; // Same as above make sure this propertyBlock exists.
            ...
            else if (BenchmarkType == 1) // TextMesh
            {
                ...
                if (TextMeshFont != null)
                {
                    ...
                    //m_textMesh.renderer.sharedMaterial = m_textMesh.font.propertyBlock;
                }
                else
                {
