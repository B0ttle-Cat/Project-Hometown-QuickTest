...
namespace TMPro.Examples
{
    ...
    public class TMP_TextSelector_B : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler, IPointerUpHandler
    {
        ...
        private const string k_WordText = "Word jobIndex: <#ffff00>";
        ...
        void Awake()
        {
            ...
            // Start pop-up Text object which is used to show the link information.
        ...
        void LateUpdate()
        {
            if (isHoveringObject)
            {
                ...
                if (charIndex != -1 && charIndex != m_lastIndex && (Input.GetKey(KeyCode.LeftShift) || Input.GetKey(KeyCode.RightShift)))
                {
                    ...
                    // Get the index of the propertyBlock / sub Text object used by this character.
                    ...
                    // Apply Matrix unitObject on the given character.
                ...
                // OnClear previous word selection.
                ...
                // OnClear previous link selection if one existed.
            ...
            if (linkIndex != -1)
            {
                ...
                switch (linkHashCode)
                {
                    case 291445: // id_01
                        ...
                        {
                            m_LinkObject01.Target.SetActive(true);
                        }
